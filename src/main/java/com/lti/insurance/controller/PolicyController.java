...
import com.lti.insurance.service.PolicyService;
...
//	@GetMapping("/policybycroptype/{croptype}")
//	public List<Policy> findPolicyByCropType(@PathVariable(value="croptype") String cropType)
//	{
//		return policyService.findPolicyByCropType(cropType);
//	}
}
